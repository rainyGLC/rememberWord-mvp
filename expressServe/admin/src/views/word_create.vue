        ...
        <div class="text item">
          ...
          label-width="80px">
            ...
            <el-form-item label="单词分类">
              <el-select v-model="word.classify_id" placeholder="请选择单词分类">
            ...
            <el-form-item>
              <el-button type="primary" @click="articleSave">保存</el-button>
...
export default {
  ...
  methods: {
    articleSave () {
      ...
      wordModel.wordAdd({ name, title, classify_id, description, zn_display, en_display })
        .then(() => {
